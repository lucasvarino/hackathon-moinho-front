      ...
      <main className={styles.mainHome}>  
        ...
        <div className={styles.blueConteiner}>
          ...
          <div className={styles.textBlueCont}>
            ...
            <h3 className={styles.textBlue}>Saiba o que os principais hospitais e clínicas estão procurando e encontre o local perfeito para trabalhar </h3>
            <div className={styles.contBtnBlue}>
              <button className={styles.btnBlue}>Crie seu perfil como Profissional</button>
            </div>
          </div>
        ...
        <div className={styles.containerThree}>
          <div className={styles.textContThree}>
            <h1>Saiba o perfil dos profissionais que estão formando nas universidades de Juiz de Fora</h1>
            <h3>Veja quais são as áreas com maior índice de formação, as universidades com mais disponibilidade de profissionais e etc</h3>

            <div className={styles.contBtnThree}>
              <button className={styles.btnThree}>Crie seu perfil como Empresa</button>
            </div>
          </div>
